...
public class DownloadResponse
{
    ...
    [JsonPropertyName("reset_time")] public string ResetTime { get; set; }

    [JsonPropertyName("reset_time_utc")] public DateTime ResetTimeUtc { get; set; }

    [JsonPropertyName("uk")] public string Uk { get; set; }
